...
/**
 * Thrown by `CatalogUiSessionGuard` when a page-level (full-page navigation) request has no valid
 ...
 * `CatalogUiController` unconditionally (see that controller's docblock — it is inert when
